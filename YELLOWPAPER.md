...
## 19 · Addenda — rules shipped after v1.0 (normative; v1.1 · 2026-09-03)
...
*HashKinetics yellowpaper v1.0 (2026-08-18) + §19 addenda v1.1 (2026-09-03). Normative companion: the reference implementation and its test suite (93 in-workspace + 17 circuit at v0.13.0); `docs/SHIELDED-POOL-SPEC.md` for narrative protocol detail; the whitepaper for motivation, economics, and history.*
