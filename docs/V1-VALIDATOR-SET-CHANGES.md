...
The founder seats are `hk-val-0/1/2` and `hk-gateway`. Before G1 (four seats at power 1) approvals from any three admitted a seat (3·3 = 9 > 2·4 = 8); since G1 (height 110,000, founding seats at power 4 — §6) the four founding approvals carried every admission up to seat #11 (2026-09-12). Seven external seats were admitted this way between 2026-09-05 and 2026-09-12 (#5–#11). Approval is checked against the CURRENT set (§6), so 16 of 23 would still pass #12; admitting the ninth external seat (#13, when the set holds 24 and 16 of 24 is exactly ⅔) is the first the rule forces — by policy every admission from #12 on carries at least one external seat's approval — the first external co-signer accepted the role on 2026-09-11; the founders never raise their own weight by certificate. Every step below is offline except the last.
