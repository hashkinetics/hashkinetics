...
- **The commit certificate costs ≈ 9.2 KB per signature** (27,633 B / 3 sigs … 394,353 B / 43 sigs — LMS/HSS signatures are kilobytes, that is the price of hash-based votes) and a certificate carries the signatures collected by commit time (≈ ⅔ of the seats + the stragglers). At testnet-1's ~3.3 s blocks of 2026-09-08 (pre-R15; 86,400 s ÷ 3.3 s ≈ 26,200 blocks/day) that is **chain growth of ≈ 2.6 GB/day at 16 seats (100,977 B × 26,200), ≈ 5 GB/day at 32 (extrapolated: ~22 sigs × 9.2 KB ≈ 202 KB/block), ≈ 10–11 GB/day at 64 (394,353 B × 26,200)** from empty blocks alone; at the ~1.3 s blocks testnet-1 runs since R15 (2026-09-13/14; ≈ 66,500 blocks/day) the same certificates grow the chain **≈ 6.7 GB/day at 16 seats, ≈ 13 GB/day at 32 (extrapolated), ≈ 26 GB/day at 64** — validators need `HK_RETAIN_BLOCKS` retention (v0.16.0) at any seat count above today's (seven seats on 2026-09-08, eleven on 2026-09-14), archive nodes need terabytes a year, and **P2 proof-of-consensus** (one STARK-aggregated certificate of ~200 KB per block, `P3.2 §P`) is the mainnet answer, not bigger disks.
