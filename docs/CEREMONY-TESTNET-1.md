...
| node version | v0.13.0 minimum at launch; the consensus minimum has moved with each activation (v0.14.0 first set change → v0.15.0 first asset tx → v0.18.1 at height 110,000 → **v0.19.0 at height 190,000**, the minimum on 2026-09-23); current release v0.19.4 (2026-09-22, client-only, security) — `networks/testnet-1/CHECKSUMS` |
