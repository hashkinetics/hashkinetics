...
- **No 30-day public soak yet** — testnet-1 launched 2026-09-02 (staging-1 before it ran six days and 107k blocks); two external seats are aboard since 2026-09-06, but the soak clock starts only after the **handover**: from height 110,000 the four genesis seats hold 16 of the power by rule (v0.18.1), and the clock runs from the day that weight is lowered by certificate so that external seats hold at least ⅓ — a dated milestone, published in the changelog when it happens. Until then the founders can decide blocks and set changes alone, and we say so.
